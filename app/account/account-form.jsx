...
// // let useRouter; // Declare the useRouter variable

// // // Conditionally import the useRouter hook to avoid server-side rendering issues
...
//   //     try {
//   //       // Your asynchronous code that should only run on the client side
//   //     } catch (error) {
//   //       // Handle the error...
//   //     }
//   //   };
...
//   //     fetchData();
//   //   }
//   // }, [userData]); // Add any dependencies as needed
...
//^^code above from working account-form on 11/18 one used on youtube first one
...
export default function AccountForm({ session }) {
  ...
  const handleAvatarUpload = (url) => {
    setUserData({ ...userData, avatar_url: url });
    console.log('uploadedPictureUrl:', url);
    //onAvatarUpload(url);
  };
