...
export default function ProfileBar({ uploadedPictureUrl }) {
  return (
    <div>
            ...
            <MDBCard style={{marginTop:'-20px'}}>
              <div className="rounded-top text-white d-flex flex-row" style={{ backgroundImage: 'url(cover.png)', height: '160px' }}>
                <div className="ms-4 mt-5 d-flex flex-column" style={{ width: '150px' }}>
                  ...
                  {/* <MDBCardImage src={uploadedPictureUrl || 'https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-profiles/avatar-1.webp'} alt="Generic placeholder image" className="mt-4 mb-2 img-thumbnail" fluid style={{ width: '120px', zIndex: '1' }} />
